            ...
            using (var db = new MintBicycleDataContext())
            {
                var query = (from users in db.UserInfo
                             ...
                             select new
                             {
                                 ...
                                 PhotoUrl = pp.Url == null ? string.Empty : pp.Url
                             });
                if (query.Any())
                {
            ...
            using (var db = new MintBicycleDataContext())
            {
                var query = (from users in db.UserInfo
                             ...
                             select new
                             {
                                 ...
                                 PhotoUrl = pp.Url == null ? string.Empty : pp.Url,
                                 StatusStr = LogService.GetAuthState(int.Parse(rr.status.ToString() == null ? "0" : rr.status.ToString())),
                             });
                if (query.Any())
                {
                    var sk = query.FirstOrDefault();
        ...
        public ResultModel AddUserAuthentication(AddUserAuth_PM data)
        {
            ...
            using (var db = new MintBicycleDataContext())
            {
                ...
                else
                {
                    ...
                    UserAuth.UserAuthGuid = Guid.NewGuid();
                    UserAuth.UserInfoGuid = data.UserInfoGuid;
                    UserAuth.UserName = data.UserName;
                    UserAuth.AuthTypeName = "身份证";
                    UserAuth.CardNumber = data.CardNumber;
                    UserAuth.status = 1;
                    UserAuth.CreateBy = data.UserInfoGuid;
                    UserAuth.createtime = DateTime.Now;
                    UserAuth.IsDeleted = false;
        ...
        public ResultModel ReturnCarByPhone(ReturnCar_PM model)
        {
            ...
            using (var db = new MintBicycleDataContext())
            {
                ...
                if (userQuery != null)
                {
                    ...
                    if (bicycleGuid != null)
                    {
                        ...
                        try
                        {
                            ...
                            LogModel.remark = "用户还车处理成功,参数:" + parameters;
                        ...
                        catch (Exception ex)
                        {
                            ...
                            LogModel2.action_type = ActionEnum.Edit.ToString();
                            LogModel2.remark = "用户还车异常处理" + ex.Message+",参数:" + parameters2;
                            LogModel2.AdminGuid = model.OperatorGuid;
                    ...
                    else
                    {
                        ...
                        LogModel1.action_type = ActionEnum.Edit.ToString();
                        LogModel1.remark = "此用户暂无用车信息,参数:" + parameters1;
                        LogModel1.AdminGuid = model.OperatorGuid;
                ...
                else
                {
                    ...
                    dt_manager_log LogModel = new dt_manager_log();
                    LogModel.action_type = ActionEnum.Edit.ToString();
                    LogModel.remark = "没有此用户,参数:" + parameters;
                    LogModel.AdminGuid = model.OperatorGuid;
