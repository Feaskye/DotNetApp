...
namespace WebDemo.Controllers
{
    public class QrCodeNetController : Controller
    {
        ...
        {
            var codeParams = CodeDescriptor.Init(ErrorCorrectionLevel.H, "sfsfsdfdfd", QuietZoneModules.Two, 5);
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Bitmap imgTemp = new Bitmap(image);
                var imgPath = System.AppDomain.CurrentDomain.BaseDirectory + "\\" + "QrCodeNet0.gif";
